...
public class ViewSearchProfDetails_Activity extends AppCompatActivity {
    ...
    private void setDefault() {
        ...
        IntentFilter intentFilter = new IntentFilter("ViewSearchProfDetails_Activity");
...
//                        holder.tv_distance.setText(Html.fromHtml("<font color=\"#FFA000\"> <b>" + time_distance[0] + "</b></font> <font color=\"#616161\">from current location</font>"));
    ...
    private void showCommonGroupList(ArrayList<SearchDetailsModel.ResultBean.ProfessionalsBean.CommonGroupsDataBeanX> groupList) {
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(context, R.style.CustomDialogTheme);
