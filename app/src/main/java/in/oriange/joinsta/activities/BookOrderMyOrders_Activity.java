...
import in.oriange.joinsta.adapters.BookOrderMyOrdersAdapter;
...
public class BookOrderMyOrders_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_order_my_orders);
    ...
    private void init() {
        context = BookOrderMyOrders_Activity.this;
    ...
    private void setDefault() {
        ...
        IntentFilter intentFilter = new IntentFilter("BookOrderMyOrders_Activity");
        ...
        edtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                if (query.toString().isEmpty()) {
                    rvOrders.setAdapter(new BookOrderMyOrdersAdapter(context, mFilteredOrderList));
                    return;
                }
                ...
                if (!query.toString().equals("")) {
                    ...
                    rvOrders.setAdapter(new BookOrderMyOrdersAdapter(context, ordersSearchedList));
                } else {
                    rvOrders.setAdapter(new BookOrderMyOrdersAdapter(context, mFilteredOrderList));
                }
            }
    ...
    private void showOrderStatusListDialog() {
        ...
        builder.setPositiveButton("Apply", (dialog, which) -> {
            ...
            if (selectedTypeCount == 0) {
                ...
                rvOrders.setAdapter(new BookOrderMyOrdersAdapter(context, orderList));
            } else {
