...
public class AddGroupSupervisor_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_groupsupervisor);
    ...
    private void init() {
        context = AddGroupSupervisor_Activity.this;
    ...
    private void submitData() {
        ...
        if (Utilities.isNetworkAvailable(context)) {
            new AddGroupSupervisor().execute(mainObj.toString().replace("\'", Matcher.quoteReplacement("\\\'")));
        } else {
            Utilities.showMessage(R.string.msgt_nointernetconnection, context, 2);
        }
    }

    private class AddGroupSupervisor extends AsyncTask<String, Void, String> {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        tv_title.setText("Group supervisor added successfully");
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(AddGroupSupervisor_Activity.this);
    }
