...
public class AddOffers_Activity extends AppCompatActivity {
    ...
    private void setEventHandler() {
        ...
        imv_iamge_one.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IMAGE_TYPE = 1;
                selectImage();
        ...
        imv_iamge_two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IMAGE_TYPE = 2;
                selectImage();
        ...
        imv_iamge_three.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IMAGE_TYPE = 3;
                selectImage();
                        ...
                        if (IMAGE_TYPE == 1) {
                            ...
                            if (!imageUrl.equals("")) {
                                Picasso.with(context)
                                        ...
                                        .resize(100, 100)
                                        .into(imv_iamge_one);
                                imv_iamge_one.setPadding(0, 0, 0, 0);
                            }
                            ...
                            if (!imageUrl.equals("")) {
                                Picasso.with(context)
                                        ...
                                        .resize(100, 100)
                                        .into(imv_iamge_two);
                                imv_iamge_two.setPadding(0, 0, 0, 0);
                            }
                            ...
                            if (!imageUrl.equals("")) {
                                Picasso.with(context)
                                        .load(imageUrl)
                                        .resize(100, 100)
                                        .into(imv_iamge_three);
                                imv_iamge_three.setPadding(0, 0, 0, 0);
                            }
                        }
                    } else {
