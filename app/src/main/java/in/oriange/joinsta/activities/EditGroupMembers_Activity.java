...
public class EditGroupMembers_Activity extends AppCompatActivity {
    ...
    private GroupMembersListModel.ResultBean memberDetails;
    ...
    private void init() {
        context = EditGroupMembers_Activity.this;
    ...
    private void setDefault() {
        memberDetails = (GroupMembersListModel.ResultBean) getIntent().getSerializableExtra("memberDetails");
    ...
    private void submitData() {
        ...
        if (Utilities.isNetworkAvailable(context)) {
            new EditGroupMember().execute(mainObj.toString().replace("\'", Matcher.quoteReplacement("\\\'")));
        } else {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        tv_title.setText("Group member details updated successfully");
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(EditGroupMembers_Activity.this);
    }
