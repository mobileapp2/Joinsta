...
public class AddGroupMembersAdmin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_group_members_admin);
    ...
    private void init() {
        context = AddGroupMembersAdmin_Activity.this;
    ...
    private void submitData() {
        ...
        if (Utilities.isNetworkAvailable(context)) {
            new AddGroupMemberAdmin().execute(mainObj.toString().replace("\'", Matcher.quoteReplacement("\\\'")));
        } else {
            Utilities.showMessage(R.string.msgt_nointernetconnection, context, 2);
        }
    }

    private class AddGroupMemberAdmin extends AsyncTask<String, Void, String> {
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(AddGroupMembersAdmin_Activity.this);
    }
