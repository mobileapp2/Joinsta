...
import in.oriange.joinsta.adapters.PaidEventsMembersNonMembersAdapter;
import in.oriange.joinsta.models.EventPaidMemberStatusModel;

public class PaidEventsMembersNonMembers_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_paid_events_members_non_members, container, false);
        context = getActivity();
    ...
    private void setDefault() {
        ...
        rv_members.setAdapter(new PaidEventsMembersNonMembersAdapter(context, membersList));
    }
        ...
        edt_search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                if (!query.toString().equals("")) {
                    ...
                    rv_members.setAdapter(new PaidEventsMembersNonMembersAdapter(context, memberSearchedList));
                } else {
                    rv_members.setAdapter(new PaidEventsMembersNonMembersAdapter(context, membersList));
                }
            }
