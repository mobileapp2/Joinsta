...
public class AllEventNotificationChildAdapter extends RecyclerView.Adapter<AllEventNotificationChildAdapter.MyViewHolder> {

    private Context context;
    private List<AllEventNotificationListModel.ResultBean.EventMemberDetailsBean> resultList;
    private PrettyTime p;

    public AllEventNotificationChildAdapter(Context context, List<AllEventNotificationListModel.ResultBean.EventMemberDetailsBean> resultList) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int pos) {
        ...
        final AllEventNotificationListModel.ResultBean.EventMemberDetailsBean notificationDetails = resultList.get(position);
    ...
    private void showNotification(final AllEventNotificationListModel.ResultBean.EventMemberDetailsBean notificationDetails) {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent("AllEventNotifications_Activity"));
