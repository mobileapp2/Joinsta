...
import in.oriange.joinsta.activities.ViewBookOrderBusinessOwnerOrder_Activity;
...
//                        holder.tv_mobile.setText(mobileStr);
        ...
        holder.cv_mainlayout.setOnClickListener(v ->
                context.startActivity(new Intent(context, ViewBookOrderBusinessOwnerOrder_Activity.class)
