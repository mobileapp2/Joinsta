...
import in.oriange.joinsta.activities.EditPublicOfficeRatingAndReview_Activity;
...
public class PublicOfficeRatingAndReviewAdapter extends RecyclerView.Adapter<PublicOfficeRatingAndReviewAdapter.MyViewHolder> {
    ...
    public PublicOfficeRatingAndReviewAdapter(Context context, List<PublicOfficeRatingAndReviewModel.ResultBean> reviewsList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int pos) {
        ...
        PublicOfficeRatingAndReviewModel.ResultBean resultBean = reviewsList.get(position);
    ...
    private OnMenuItemClickListener<PowerMenuItem> onHamburgerItemClickListener =
            new OnMenuItemClickListener<PowerMenuItem>() {
                ...
                public void onItemClick(int position, PowerMenuItem item) {
                    switch (position) {
                        case 0:
                            PublicOfficeRatingAndReviewModel.ResultBean ratingDetails = reviewsList.get(itemClickedPosition);
                            context.startActivity(new Intent(context, EditPublicOfficeRatingAndReview_Activity.class)
