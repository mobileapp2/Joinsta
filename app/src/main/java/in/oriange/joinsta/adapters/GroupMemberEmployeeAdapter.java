...
public class GroupMemberEmployeeAdapter extends RecyclerView.Adapter<GroupMemberEmployeeAdapter.MyViewHolder> {
    ...
    public GroupMemberEmployeeAdapter(Context context, List<GetEmployeeModel.ResultBean> resultArrayList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int pos) {
        ...
        holder.cv_mainlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, ViewGroupMemberEmpDetails_Activity.class)
