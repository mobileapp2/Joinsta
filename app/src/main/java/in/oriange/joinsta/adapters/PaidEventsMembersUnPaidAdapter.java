...
public class PaidEventsMembersUnPaidAdapter extends RecyclerView.Adapter<PaidEventsMembersUnPaidAdapter.MyViewHolder> {

    private Context context;
    private List<EventPaidMemberStatusModel.ResultBean> membersList;

    public PaidEventsMembersUnPaidAdapter(Context context, List<EventPaidMemberStatusModel.ResultBean> membersList) {
