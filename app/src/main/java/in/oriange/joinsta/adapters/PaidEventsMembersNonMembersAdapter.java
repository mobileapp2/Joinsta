...
public class PaidEventsMembersNonMembersAdapter extends RecyclerView.Adapter<PaidEventsMembersNonMembersAdapter.MyViewHolder> {

    private Context context;
    private List<EventPaidMemberStatusModel.ResultBean> membersList;

    public PaidEventsMembersNonMembersAdapter(Context context, List<EventPaidMemberStatusModel.ResultBean> membersList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.list_row_events_member_status_non_member, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int pos) {
        ...
        if (memberDetails.getPayment_mode().equals("online") || memberDetails.getPayment_mode().equals("offline")) {
        ...
        } else if (memberDetails.getPayment_mode().equals("pay_at_counter")) {
            holder.tv_status.setText("Pay at Counter");
            holder.ll_paid.setVisibility(View.GONE);
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tv_name, tv_paid_mode, tv_mobile_email, tv_status, tv_amount, tv_quantity, tv_early_bird_availed;
        ...
        public MyViewHolder(@NonNull View view) {
            ...
            ll_paid = view.findViewById(R.id.ll_paid);
