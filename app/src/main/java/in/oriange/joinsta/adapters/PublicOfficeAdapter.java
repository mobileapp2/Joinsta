...
public class PublicOfficeAdapter extends RecyclerView.Adapter<PublicOfficeAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PublicOfficeAdapter.MyViewHolder holder, int pos) {
        ...
        if (!publicOffice.getDepartment_functions().equals(""))
            holder.tv_function.setText(publicOffice.getDepartment_functions());
        else
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tv_name, tv_type_subtype, tv_function, tv_total_reviews, tv_total_rating;
