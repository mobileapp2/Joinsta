...
public class GroupSupervisorsAdapter extends RecyclerView.Adapter<GroupSupervisorsAdapter.MyViewHolder> {

    private Context context;
    private List<GroupSupervisorsListModel.ResultBean> groupMembers;
    private String groupId;

    public GroupSupervisorsAdapter(Context context, List<GroupSupervisorsListModel.ResultBean> groupMembers, String groupId) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int pos) {
        ...
        holder.btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Are you sure you want to delete this supervisor?");
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (Utilities.isNetworkAvailable(context))
                            new DeleteGroupSupervisor().execute(memberDetails.getId());
                        else
    ...
    private class DeleteGroupSupervisor extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            param.add(new ParamsPojo("type", "deleteGroupSupervisorDetails"));
            param.add(new ParamsPojo("supervisor_id", params[0]));
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        Utilities.showMessage("Group supervisor deleted successfully", context, 1);
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
